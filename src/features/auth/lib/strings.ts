...
export const AUTH_LABELS = {
  ...
  confirmPasswordLabel: 'labels.confirm-password',
  newPasswordLabel: 'labels.new-password',
  twoFactorToggleLabel: 'labels.two-factor-toggle',
  otpLabel: 'labels.otp-code',
