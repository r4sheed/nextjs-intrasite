...
export const AUTH_ERROR_MESSAGES = {
  ...
  CONFIRM_PASSWORD_REQUIRED: 'auth.errors.confirm_password_required', // Please confirm your password
  CONFIRM_PASSWORD_MISMATCH: 'auth.errors.confirm_password_mismatch', // The provided passwords do not match
  ...
  SIGNUP_FAILED: 'auth.errors.signup_failed', // Sign up failed. Please try again.
} as const;

export const AUTH_UI_MESSAGES = {
  SIGNUP_TITLE: 'auth.ui.signup_title', // Create an account
  LOGIN_TITLE: 'auth.ui.login_title', // Sign in
  EMAIL_VERIFICATION_TITLE: 'auth.ui.email_verification', // Email verification
  SIGNUP_SUBTITLE: 'auth.ui.signup_subtitle', // Enter your details to create your account
  ...
  CONFIRM_PASSWORD_LABEL: 'auth.ui.confirm_password_label', // Confirm password
  FORGOT_PASSWORD: 'auth.ui.forgot_password', // Forgot password?
  LOGIN_BUTTON: 'auth.ui.login_button', // Sign in
  SIGNUP_BUTTON: 'auth.ui.signup_button', // Create account
  ...
  PLACEHOLDER_CONFIRM_PASSWORD: 'auth.ui.placeholder_confirm_password', // Confirm your password
  ...
  SIGNUP_FAILED: 'auth.errors.signup_failed', // Sign up failed. Please try again.
  SUCCESS_SIGNUP: 'auth.success.signup', // Account created successfully!
