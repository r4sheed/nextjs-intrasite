...
### 🔧 Enhanced i18n Management Script

**Priority:** Medium  
**Status:** Not Started

**Description:**  
Create a new comprehensive i18n management script that replaces the current `i18n add` command with support for multiple CRUD operations (Create, Read, Update, Delete) on i18n keys and translations.

**Features:**

- **Add Keys:** Add new i18n keys to all locale files with default values
- **Update Keys:** Modify existing key values across locales
- **Delete Keys:** Remove keys from all locale files
- **List Keys:** Display existing keys with their translations
- **Validate Keys:** Check for missing translations or inconsistencies
- **Batch Operations:** Support for bulk operations via config files

**Implementation Details:**

- Create `scripts/i18n/manage.ts` as the main entry point
- Support subcommands: `add`, `update`, `delete`, `list`, `validate`
- Use existing helpers from `scripts/i18n/helpers.ts`
- Integrate with existing sync and sort functionality
- Add proper error handling and validation

**Benefits:**

- ✅ Unified interface for all i18n operations
- ✅ Better maintainability than separate scripts
- ✅ Support for complex workflows
- ✅ Improved developer experience

**Affected Files:**

- `scripts/i18n/manage.ts` (new script)
- `package.json` (add new npm script)
- `scripts/i18n/helpers.ts` (extend if needed)
...
- Ensure compatibility with existing sync/sort scripts
